...
def plot_metric_comparison_with_zoom(metric_key, metric_label, custom_labels):
    ...
    ax_inset.set_ylim(0.71, 0.78)  # 这里设置放大图的y轴范围
    ax_inset.set_xticks([280, 290, 300])
    ax_inset.set_yticks([0.71, 0.75, 0.78])
    ...
    # 保存并显示图像
    save_path = f'/final/improved-yolov11/plot_results/stbd08/{metric_label}_zoomed.png'
